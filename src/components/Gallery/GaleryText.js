function GaleryText() {
  ...
  return (
    <div className="container overflow-hidden mx-auto mm:text-center sm:text-left flex flex-col max-w-[90%] sm:ml-20 bg-[#f7f7f7]">
      <h2 className="text-secondary text-[21.5px] font-robotoCondensed">
        {companyPresentationText}
      </h2>
      <h1 className="font-bebas text-[40px] text-accent">
        {galleryTitleText}
      </h1>
      ...
      <div className="mm:text-center flex flex-row gap-10 mt-5">
        ...
        <h4 className="text-accent text-[15px] font-robotoFlex font-semibold">
          {carCategory2}
        </h4>
      </div>
    </div>
